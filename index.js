...
for (let i = 0; i <= hacker1.length * 2 - 1; i++) {
  if (i == 0) {
    driverSepareted = hacker1[0];
  } else if (i % 2 === 0) {
    driverSepareted += hacker1[i / 2].toUpperCase();
  } else {
    driverSepareted += " ";
  }
}

console.log(driverSepareted);
...
if (hacker1.localeCompare(hacker2) == -1) {
  console.log("The driver's name goes frist");
