...
let bonus1= ("is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged. It was popularised in the 1960s with the release of Letraset sheets containing Lorem Ipsum passages, and more recently with desktop publishing software like Aldus PageMaker including versions of Lorem Ipsum")
...
// NUMBER OF "ET" OCCURENCES

function countEt(string) {
    let count = 0;
    for (i = 0; i < string.length; i++) {
        let match;
        match = string[i].includes("et"); //look if each element of the array contains the string
        if (match == true) {
            count++; //count the number of occurences by incrementing count
        }
    }
    console.log(`The text containts ${count} occurences of the string "et"`);
}
