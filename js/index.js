...
let firstLetterDriver = hacker1[0]
let firstLetterNavigator = hacker2[0]
let positionDriver = 0
let positionNavigator=0
for(let i=0; i < stringABC.length;i++){
    if (stringABC[i]===firstLetterDriver){
        positionDriver=i
    } else if(stringABC[i]===firstLetterNavigator)
        positionNavigator=i
}
