...
let position = 0;
while (i < str.length) {
  position = str.indexOf(" et ",lastPosition);
  if (position > lastPosition) {
    lastPosition = position+1;
    position++;
    countEt++;
    console.log(`Position : ${position}, Last position : ${lastPosition}, Count of "et" : ${countEt}`);
  }
  i++;
}
...
while (i < cleanPhrase.length) {
  ...
  //console.log(cleanPhrase[i])
  //console.log(cleanPhrase[j])
  i++;
  j--;
};
