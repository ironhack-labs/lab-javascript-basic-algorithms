...
let phraseToCheck = "Madam, I'm Adam"

console.log(phraseToCheck.length)

for(index1 = 0; index1 < phraseToCheck.length; index1+=1){
    resultado1 = phraseToCheck[index1]
    console.log(resultado1)
}

for(index2 = phraseToCheck.length -1; index2 >=0; index2-=1){
    resultado2 = phraseToCheck[index2]
