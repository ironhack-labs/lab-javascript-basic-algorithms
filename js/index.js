...
let justAlpha = palindrome.toLowerCase().replace(/[\W_]/g, "");
// console.log(justAlpha)
let reversePal = justAlpha.split("").reverse().join("");
// console.log(reversePal)
if (justAlpha === reversePal) {
...
// str = palindrome.replace(/[^a-z0-9+]+/gi, '');
// str2 = str.replace(/\(.+?\)/g, '');
