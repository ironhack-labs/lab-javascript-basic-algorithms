...
// +trim() if the strin. possibly could start/end with a/ blank(s)
...
let extraCount=0;
  ...
  //no else !!
console.log("4.1 Bonus: 'et' count: " + (lorys.split(" et ").length + extraCount));
...
// } else {
//   console.log(phraseToCheck + " is no palyndrome");
// }

let phraseToCheck="stack cats";
//this one is better (if you don't wan't to include special chars) so... -->
//remove all special Characters like ",.?=§&/(....." only allow latin alphabet (without numbers 1,2,3,4,5...)
