...
let loremArr = loremText.split(' ');

// 1.1 Number of words
console.log(`The string has ${loremArr.length} words.`);
...
console.log(`The word 'et' appears ${counter} times in the string`);

// Bonus 2: Palindromes
let input = prompt('Type something you think might be a palindrome');
