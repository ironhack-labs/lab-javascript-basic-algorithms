...
for (let i = 0; i < string.length; i++) {
  ...
  palindrome += string[i].toLowerCase();
}
...
if (palindrome === reversePalindrome) {
  console.log(
    "Yeay!!! the following sentence : " + string + " IS a palindrome"
  );
} else if (palindrome !== reversePalindrome) {
  console.log("The following sentence : " + string + " is NOT a palindrome");
}
