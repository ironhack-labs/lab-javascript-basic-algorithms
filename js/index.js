...
if (hacker1.length > hacker2.length && hacker1.length > hacker3.length) {
    console.log(`"The driver ${hacker1} has the longest name, it has       
      ...
      console.log(`"It seems that the navigator ${hacker3} has the longest name, it has ${hacker3.length} characters."`)}
      else {
        console.log(`"Wow, you three have equally long names, ${hacker3.length} characters!"`)
      }
