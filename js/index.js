...
// Bonus 2
// let phraseToCheck = "aamr Romaa"
// let joinedString = phraseToCheck.split(" ").join("").split(",").join("").toLowerCase()
// console.log(joinedString)
// for (let i = 0; i <= (joinedString.length / 2); i ++ ) {
//     if (joinedString[i] !== joinedString[joinedString.length - 1 - i]) {
//         console.log("It is not a palindrome")
//         break
//     }else {

//         if (i === (joinedString.length / 2)) console.log("entra aqui")
//         continue
//     }
