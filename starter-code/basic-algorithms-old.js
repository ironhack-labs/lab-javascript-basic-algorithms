...
console.log("There are " + (words.length - 1) + " words in the lore ipsum text above.");

let ets = ipsum.split('et');
console.log("The latin word 'et' appears " + (ets.length - 1) + " times in the lore ipsum text above.");
